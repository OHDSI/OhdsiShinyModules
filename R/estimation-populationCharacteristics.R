...
#' 
#' @export
estimationPopulationCharacteristicsServer <- function(
    id, 
    selectedRow, 
    inputParams, 
    connectionHandler, 
    ...
    function(input, output, session) {
      ...
      output$table1Table <- DT::renderDataTable({
        ...
        if (is.null(row)) {
          ...
          table1 <- prepareEstimationTable1(
            balance = balance,
...
prepareEstimationTable1 <- function(
    balance,
