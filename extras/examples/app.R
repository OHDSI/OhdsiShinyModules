...
keyringName = 'ohda'
#password for ohda = "***REMOVED***"
Sys.setenv(resultsAdmin = "ohda_project_sa")
Sys.setenv(resultsAdminPassword = "***REMOVED***")
Sys.setenv(resultsDbConnectionString = "***REMOVED***")
...
# keyring::key_set_with_value("resultsAdminPassword", password = "***REMOVED***", keyring = keyringName)
# keyring::key_set_with_value("resultsReadOnlyUser", password = "ohda_project_ro", keyring = keyringName)
# keyring::key_set_with_value("resultsReadOnlyPassword", password = "***REMOVED***", keyring = keyringName)
# resultsDbConnectionString <- "***REMOVED***"
