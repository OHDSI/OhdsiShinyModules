...
withr::defer({
  ...
  connectionHandlerCG$closeConnection()()
  connectionHandlerPlp$closeConnection()()
  connectionHandlerCharacterization$closeConnection()()
  connectionHandlerDataDiag$closeConnection()()
  connectionHandlerCohortDiag$closeConnection()()
  connectionHandlerEstimation$closeConnection()()
  connectionHandlerSccs$closeConnection()()
  connectionHandlerES$closeConnection()()
  connectionHandlerDS$closeConnection()()
  connectionHandlerPV$closeConnection()()
}, testthat::teardown_env())
