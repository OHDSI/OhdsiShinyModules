...
from @result_schema.@my_table_appenddiagnostic_summary a 
inner join @result_schema.@my_table_appenddiagnostics b
on a.DIAGNOSTIC_ID = b.DIAGNOSTIC_ID
inner join @result_schema.@my_table_appenddatabase_details c
on c.database_id = b.database_id
inner join @database_table_appenddatabase_meta_data dm
...
sql <- SqlRender::render(
    ...
    database_table_append = params$databaswTableAppend,
...
inner join @result_schema.@my_table_appenddiagnostics b
  where a.DIAGNOSTIC_ID = b.DIAGNOSTIC_ID
  and b.model_design_id = @model_design_id
...
sql <- SqlRender::translate(
  ...
  tempPredTable <- DatabaseConnector::querySql(
    connection = params$connection, 
    sql = sql, 
    snakeCaseToCamelCase = T
    )
