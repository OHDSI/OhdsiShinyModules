...
- fixed estimation target cohort selector (there was a small bug when all cohorts were subsets)
- updated required OhdsiReportGenerator as that ensures cohort method results have an indication id
